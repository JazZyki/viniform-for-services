...
export const USER_ROLES = {
    ...
    AUTOVOLF1: CBAUTO_CONFIG,
    AUTOVOLF2: CBAUTO_CONFIG,
    AUTONOVA1: CBAUTO_CONFIG,
    AUTONOVA2: CBAUTO_CONFIG,
    FRANCECAR1: CBAUTO_CONFIG,
    FRANCECAR2: CBAUTO_CONFIG,
    ACLUKAS1: CBAUTO_CONFIG,
    ACLUKAS2: CBAUTO_CONFIG,
    AUTOPOLY1: CBAUTO_CONFIG,
    AUTOPOLY2: CBAUTO_CONFIG,
    MOTOMORAVA1: CBAUTO_CONFIG,
    MOTOMORAVA2: CBAUTO_CONFIG,
    MBMORAVIA1: CBAUTO_CONFIG,
    MBMORAVIA2: CBAUTO_CONFIG,
    MBSEVER1: CBAUTO_CONFIG,
    MBSEVER2: CBAUTO_CONFIG,
    AUTOTICHY1: CBAUTO_CONFIG,
    AUTOTICHY2: CBAUTO_CONFIG,
    LAROS: CBAUTO_CONFIG,
    AUTOHELLER1: CBAUTO_CONFIG,
    AUTOHELLER2: CBAUTO_CONFIG,
    AUTOTOMAN: CBAUTO_CONFIG,
    RTTORAX: CBAUTO_CONFIG,
    SAG: CBAUTO_CONFIG,
    SERVIND: CBAUTO_CONFIG,
    CARTECOC: CBAUTO_CONFIG,
    CARTECOS1: CBAUTO_CONFIG,
    CARTECOS2: CBAUTO_CONFIG,
    DRIVALIA: CBAUTO_CONFIG,
    INVELTPHA: CBAUTO_CONFIG,
